...
import 'package:chill_money/features/settings/presentation/screen/main_settings/widgets/settings.dart';
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              ListView.builder(
                                shrinkWrap: true,
                                itemCount: settingsService.settingsList.length,
                                physics: NeverScrollableScrollPhysics(),
                                itemBuilder: (context, index) {
                                  return SettingModule(
                                    settings:
                                        settingsService.settingsList[index],
                                  );
                                },
                              ),
                            ],
